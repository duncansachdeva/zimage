            ...
            for file_idx, file in enumerate(self.files, 1):
                ...
                for action_idx, action in enumerate(self.actions, 1):
                    ...
                    if action_idx < len(self.actions):
                        ...
                        temp_file = f"{base}.temp{action_idx}{ext}"
                    else:
...
class MainWindow(QMainWindow):
    ...
    def init_status_bar(self):
        ...
        # Add a toggle button for theme switching to the status bar
        toggle_button = QPushButton("Toggle Theme")
        toggle_button.clicked.connect(self.on_toggle_theme)
        status_bar.addPermanentWidget(toggle_button)
